...
const BettingProviders = () => {
  useEffect(() => {
    document.title = 'OPay Document | Betting Providers';
    return () => {
  ...
  return (
    <>
      <section className="text-justify">
        <div className="p-4">
          <h1 className="text-2xl font-bold capitalize mb-4 scroll-mt-32">Betting Providers</h1>
          <p className="mb-2">This API provides a list of supported betting providers along with their unique identifiers for payment processing. Merchants can use it to initiate deposits, payouts, and account validations for betting customers.</p>
          <p className='mb-2'>The API ensures secure, fast, and reliable communication between payment systems and betting operators.</p>
        </div>
        ...
        <AccordionItem title="Request Path" id="request-path">
          <div>
            ...
            <div className={`w-full border-l-5 ${theme === "dark" ? "dark border-[#F9FBFC]" : "border-blue-950"} rounded-lg p-5 py-8 bg-[#26d99d] mt-4`}>
              ...
              <p className='bg-[#F9FBFC] text-gray-900 inline wrap-anywhere rounded-md p-1'>https://testapi.opaycheckout.com/api/v1/international/payout/betting-providers</p>
            </div>
            ...
            <div className={`w-full border-l-5 ${theme === "dark" ? "dark border-[#F9FBFC]" : "border-blue-950"} rounded-lg p-5 py-8 bg-[#26d99d] mt-4`}>
              ...
              <p className='bg-[#F9FBFC] text-gray-900 inline wrap-anywhere rounded-md p-1'>https://liveapi.opaycheckout.com/api/v1/international/payout/betting-providers</p>
            </div>
          </div>
        </AccordionItem>
...
export default BettingProviders;
