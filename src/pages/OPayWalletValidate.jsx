...
const OPayWalletValidate = () => {
  useEffect(() => {
    document.title = 'OPay Document | Opay Wallet Validate';
    return () => {
      ...
      table: `<table>
          ...
          <tbody>
            <tr>
              ...
              <td>Yes</td>
              <td>1129000042</td>
              <td>Phone number for Opay wallet</td>
            </tr>
          </tbody>
        </table>`,
    },
  ...
  return (
    <>
      <section className="text-justify">
        <div className="p-4">
          <h1 className="text-2xl font-bold capitalize mb-4 scroll-mt-32">OPay wallet validate</h1>
          <p className="mb-2">This API helps authorized Merchants to confirm the validity of an OPay wallet before processing payments or transfers. It verifies that the wallet number provided is active and correctly linked to the intended user.</p>
          <p className='mb-2'>The API returns essential details such as the wallet owner's name and a validation status. This helps prevent payment errors, fraud, and chargebacks by verifying beneficiary details in real-time.</p>
        </div>
        ...
        <AccordionItem title="Request Path" id="request-path">
          <div>
            ...
            <div className={`w-full border-l-5 ${theme === "dark" ? "dark border-[#F9FBFC]" : "border-blue-950"} rounded-lg p-5 py-8 bg-[#26d99d] mt-4`}>
              ...
              <p className='bg-[#F9FBFC] text-gray-900 inline wrap-anywhere rounded-md p-1'>https://testapi.opaycheckout.com/api/v1/international/payout/opay-wallet-validate</p>
            </div>
            ...
            <div className={`w-full border-l-5 ${theme === "dark" ? "dark border-[#F9FBFC]" : "border-blue-950"} rounded-lg p-5 py-8 bg-[#26d99d] mt-4`}>
              ...
              <p className='bg-[#F9FBFC] text-gray-900 inline wrap-anywhere rounded-md p-1'>https://liveapi.opaycheckout.com/api/v1/international/payout/opay-wallet-validate</p>
            </div>
          </div>
        </AccordionItem>
...
export default OPayWalletValidate;
