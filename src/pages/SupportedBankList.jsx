...
const SupportedBankList = () => {
  useEffect(() => {
    document.title = 'OPay Document | Supported Bank List';
    return () => {
  ...
  const responseParameterTable = [
    {
      table: `<table>
          ...
          <tbody>
            ...
            <tr>
              <td>data</td>
              <td>List<TransferBank></td>
              <td></td>
              <td>[ <br />
                { <br />
                "bankCode": "044", <br />
                "bankName": "Access Bank" <br />
                }, <br />
                { <br />
                "bankCode": "401", <br />
                "bankName": "ASOSavings & Loan" <br />
                }
                <br /> ]</td>
            </tr>
          </tbody>
  ...
  return (
    <>
      <section className="text-justify">
        <div className="p-4">
          <h1 className="text-2xl font-bold capitalize mb-4 scroll-mt-32">Supported Bank List</h1>
          <p className="mb-2">This API provides an up-to-date list of all banks available for transactions through our platform. It includes details like bank names, codes, and other identifiers, which is vital for enabling smooth and error-free payment processing.</p>
        </div>
        ...
        <AccordionItem title="Request Path" id="request-path">
          <div>
            ...
            <div className={`w-full border-l-5 ${theme === "dark" ? "dark border-[#F9FBFC]" : "border-blue-950"} rounded-lg p-5 py-8 bg-[#26d99d] mt-4`}>
              ...
              <p className='bg-[#F9FBFC] text-gray-900 inline wrap-anywhere rounded-md p-1'>https://testapi.opaycheckout.com/api/v1/international/banks</p>
            </div>
            ...
            <div className={`w-full border-l-5 ${theme === "dark" ? "dark border-[#F9FBFC]" : "border-blue-950"} rounded-lg p-5 py-8 bg-[#26d99d] mt-4`}>
              ...
              <p className='bg-[#F9FBFC] text-gray-900 inline wrap-anywhere rounded-md p-1'>https://liveapi.opaycheckout.com/api/v1/international/banks</p>
            </div>
          </div>
        </AccordionItem>
...
export default SupportedBankList;
