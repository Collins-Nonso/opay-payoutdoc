...
const BettingCustomerValidate = () => {
  useEffect(() => {
    document.title = 'OPay Document | Betting Customer Validate';
    return () => {
      ...
      table: `<table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>Yes</td>
              <td>1259257649123</td>
              <td>The customerId of the betting
provider.</td>
            </tr>
          </tbody>
        </table>`,
      ...
      table: `<table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>[{ <br />
                "provider": "BET9JIA", <br />
                "providerLogoUrl": "http://logourl.com", <br />
                "minAmount": "1000000", <br />
                "maxAmount": "200000000" <br />
                },{ <br />
                "provider": "BETTING", <br />
                "providerLogoUrl": "http://logourl.com", <br />
                "minAmount": "1000000", <br />
      ...
      table: `<table>
          ...
          <tbody>
            <tr>
              <td>provider</td>
              <td>String</td>
              <td>Provider for betting.</td>
            </tr>
            <tr>
              <td>providerLogoUrl</td>
              <td>String</td>
  ...
  return (
    <>
      <section className="text-justify">
        <div className="p-4">
          <h1 className="text-2xl font-bold capitalize mb-4 scroll-mt-32">Betting Customer Validate</h1>
          <p className="mb-2">This helps authorized Merchants to confirm the identity and validity of a betting customer's account before processing transactions. It accepts customer details, such as account ID or username, and verifies them with the selected betting provider.</p>
          <p className='mb-2'>The API ensures that deposits, withdrawals, or bets are linked to an active and legitimate account. It helps prevent fraudulent activities and reduces errors in payment processing. This validation step is crucial for secure and compliant betting operations.</p>
        </div>
        ...
        <AccordionItem title="Request Path" id="request-path">
          <div>
            ...
            <div className={`w-full border-l-5 ${theme === "dark" ? "dark border-[#F9FBFC]" : "border-blue-950"} rounded-lg p-5 py-8 bg-[#26d99d] mt-4`}>
              ...
              <p className='bg-[#F9FBFC] text-gray-900 inline wrap-anywhere rounded-md p-1'>https://testapi.opaycheckout.com/api/v1/international/payout/betting-customer-validate</p>
            </div>
            ...
            <div className={`w-full border-l-5 ${theme === "dark" ? "dark border-[#F9FBFC]" : "border-blue-950"} rounded-lg p-5 py-8 bg-[#26d99d] mt-4`}>
              ...
              <p className='bg-[#F9FBFC] text-gray-900 inline wrap-anywhere rounded-md p-1'>https://liveapi.opaycheckout.com/api/v1/international/payout/betting-customer-validate</p>
            </div>
          </div>
        </AccordionItem>
...
export default BettingCustomerValidate;
